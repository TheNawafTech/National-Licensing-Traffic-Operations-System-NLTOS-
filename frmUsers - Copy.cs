    ...
    public partial class frmUsers : Form
    {
        ...
        private void _ApplyFilter()
        {
            ...
            switch (cbFindBy.SelectedItem?.ToString())
            {
                ...
                case "Person ID":
                    {
                        Operations_.Settings.ApllyTools(ref txtSearchValue, ref dt, "PersonID", filterText);
                        break;
                ...
                case "User ID":
                    {
                        Operations_.Settings.ApllyTools(ref txtSearchValue, ref dt, "UserID", filterText);
                        break;
                    }

                case "UserName":
                    {
                        Operations_.Settings.ApllyTools(ref txtSearchValue, ref dt, "UserName", filterText);
                        break;

                    }
                case "Full Name":
                    {
                        Operations_.Settings.ApllyTools(ref txtSearchValue, ref dt, "FullName", filterText);
                        break;
                    }
                case "Is Active":
                    {
        ...
        private void showDeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmCurrentUser.frmCurrentUser frm = new frmCurrentUser.frmCurrentUser(User);
                frm.ShowDialog();
                _ResetTheValues(); // Refresh the data
            }
